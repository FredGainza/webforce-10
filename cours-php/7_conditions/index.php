        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php 
              ...
              echo ($cinq > $deux) ?  $cinq.' est bien supérieur à '.$deux : ""; // équivalent ternaire
            ?>
            ...
            <?php
              if ($cinq < $deux){
                // Pour échapper des caractères utilisés comme ci-dessous l'antislash
                echo 'On est d\'accord pour dire que c\'était faux?';
              }elseif($cinq == $deux){
