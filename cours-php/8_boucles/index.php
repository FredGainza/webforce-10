        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php
              ...
              /*
                Tant que tu n'as pas atteint la valeur , tu ajoutes
              ...
              */
              ...
              echo '<ul>';
                while ($chiffre <= 5){
                  echo '<li>Numéro du titre de boucle : '.($chiffre +1).'</li>';
                  $chiffre++; // J'incrémente de 1 le chiffre de base
                }
              echo '</ul>';
            ...
            <ul>
              <?php $chiffre = 0; ?>
              <?php while ($chiffre <= 5) : ?>
                <li>Numéro du titre de boucle : <?=($chiffre +1); ?></li> 
                <?php $chiffre++; ?>
              <?php endwhile; ?> <!-- j'Incrémente le 1 le chiffre en base  -->
            </ul>
            ...
            <?php
              ...
              do {
                // Affiche la première lettre en maj suivit d'un point
            ...
            switch ($i) {
              ...
              case 2:
                ...
                break;
              default:
                echo 'Je n\'ai pas trouvé la valeur correspondante';
            }
            ?>
            ...
            <?php
              ...
              foreach ($notes_jeux_video as $nom_du_jeu => $note) {
                echo '<p>'. $nom_du_jeu. ' a obtenu la note de : '. $note.'</p>';
            }
            ?>

            <?php foreach ($notes_jeux_video as $nom_du_jeu => $note) : ?>
